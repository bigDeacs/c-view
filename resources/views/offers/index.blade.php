	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
			<div class="panel panel-default">
				<div class="panel-heading"><h1>Offers<a href="{{ url('/home/offers/create') }}" class="btn btn-primary btn-lg"style="float: right;">Create</a></h1></div>
							    ...
							    <tbody>
							       @foreach ($offers as $offer)
										...
										@endif
											<td>{!! $offer->id !!}</td>
											<td>{!! $offer->promo !!}</td>
											<td><img src="/images/{!! $offer->thumb !!}" class="img-responsive" width="150" /></td>
											<td>
